                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-right">
                                    ...
                                    <li class="breadcrumb-item">膀胱癌預測模型</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function getAllName() {
        $.ajax({
            url: "<?php echo base_url('BladderCancer/getAllName')?>",
            method: "post",
            contentType: false,
            cache: false,
            processData: false,
        ...
        $('#Input_data_disease').on('submit', function (even) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('BladderCancer/ml_Model')?>",
                        method: "post",
                        dataType: "json",
                        data: {
    ...
    function out() {
        $.ajax({
            url: "<?php echo base_url('BladderCancer/Logout')?>",
            type: "post",
            success: function (data) {
