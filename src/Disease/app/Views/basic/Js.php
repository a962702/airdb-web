...
<!-- Alertify js -->
<script src="<?php echo base_url('assets/plugins/alertify/js/alertify.js') ?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/pages/alertify-init.js') ?>" type="text/javascript"></script>
<script src="<?php echo base_url() ?>assets/plugins/dropzone/dist/dropzone.js" type="text/javascript"></script>
<!--Summernote js-->
