                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-right">
                                    ...
                                    <li class="breadcrumb-item">肺腺癌預測模型</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function getAllName() {
        $.ajax({
            url: "<?php echo base_url('LungAdenocarcinoma/getAllName')?>",
            method: "post",
            contentType: false,
            cache: false,
            processData: false,
            success: function (data) {
                ...
                for (var i = 0; i < Return_data.length; i++) {
                    document.getElementById("inputCheckbox").innerHTML +=
                        ...
                        "<input type='checkbox' class='custom-control-input'" + "id=" + Return_data[i] + ">" +
                        "<label class='custom-control-label' for=" + Return_data[i] + " style='margin-right: 50px'>" + Return_data[i] + "</label>" +
                        "</div>";
                }
            }
        });
        ...
        $('#Input_data_disease').on('submit', function (even) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('LungAdenocarcinoma/ml_Model')?>",
                        method: "post",
                        dataType: "json",
                        data: {
    ...
    function out() {
        $.ajax({
            url: "<?php echo base_url('LungAdenocarcinoma/Logout')?>",
            type: "post",
            success: function (data) {
